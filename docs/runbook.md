...
the question anchor. Speech, the model and persistence are still fake, each
named in the table at the top of `apps/desktop/src/main/index.ts` with the PR
that takes it. **The model is still
...
selected (`docs/handoff.md` §1 step 9).
